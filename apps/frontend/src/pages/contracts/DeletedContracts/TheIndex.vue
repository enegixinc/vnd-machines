    ...
    <div>
        ...
        >
            <template #actions="{ data }">
                <button
                    type="button"
                    v-tippy="$t('contractsPages.recoverContract')"
                    @click="recoverUser(data.value._id)"
...
<script setup lang="ts">
    ...
    const {
        ...
        totalPages,
        pageSize,
        entityData: contractsData,
        fetchEntities: deletedContracts,
        DataTable,
        TheBreadcrumbs,
        rowLoading,
        recoverEntity: recoverUser,
    } = useContract({
