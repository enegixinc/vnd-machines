    ...
    <div>
        ...
        >
            <template #actions="{data}">
                <button type="button" v-tippy="$t('categoriesPages.recoverCategory')"
                        @click="recoverCategory(data.value._id)" :disabled="(rowLoading === data.value._id || !!rowLoading)" >
...
const tableFields=computed(()=>{
    return [
        {field: 'name.ar', title: t("fields.categoryName"), hide: false, sort: false,
