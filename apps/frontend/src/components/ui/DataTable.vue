            ...
            <div class="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                ...
                <div class="flex flex-wrap md:flex-nowrap items-center gap-5 ltr:ml-auto rtl:mr-auto">
                    <div class="flex items-center gap-5 ltr:ml-auto rtl:mr-auto">
                        ...
                        <div>
                            <input v-model="search" type="text" class="form-input w-full" :disabled="!loading" :placeholder="$t('dataTable.search')" />
                        </div>
                    </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div v-if="!hideDelete">
                                    <button
                                        type="button"
                                        v-tippy="$t('delete')"
                                        @click="emit('deleteRow', data.value._id)"
...
<script setup lang="ts">
    ...
    const randomColor = () => {
        const color = ['bg-primary', 'bg-secondary', 'bg-success', 'bg-danger', 'bg-warning', 'bg-info'];
    ...
    const changeServer = (data: any) => {
        const filters = data.column_filters
            .filter((element) => (element.condition && element.value) || element.condition === 'is_null' || element.condition === 'is_not_null')
            .map((element) => {
