...
import { Form, Grid, Input, Radio, Space, Spin, Table } from 'antd';
...
export const ProductsListPage: React.FC<Props> = ({ children }) => {
  ...
  const {
    ...
    setFilters,
    tableQueryResult,
  } = useTable<SerializedProductDto, HttpError, { name: string }>({
    pagination: {
      pageSize: 12,
    },
    meta: {},
          ...
          columns={[
            {
              ...
              render: (_, value) => {
                const defaultSrc =
                  'https://www.brandi.com.ar/wp-content/uploads/2020/08/a-no-foto.png';
                const firstImage = value.productPictures[0];
            ...
            },
            {
              ...
              dataIndex: ['name', 'en'],
              sorter: true,
              render: (_, record) => record.name.en ?? 'N/A',
            },
            {
              title: 'Supplier',
              dataIndex: ['supplier', 'name'],
              sorter: true,
              render: (_, record) => record.description.en ?? 'N/A',
            },
            {
              title: 'Category',
            ...
            },
            {
              ...
              sorter: true,
              render: (_, record) => record.brand ?? 'N/A',
            },
          ]}
          scroll={{ x: true }}
          sticky
