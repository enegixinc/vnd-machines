...
import type { GetOneQueryResponse, GetOnePathParams, GetOneQueryParams } from "../../types/GetOne";
...
import type { MaybeRef } from "vue";
 ...
 type GetOneClient = typeof client<GetOneQueryResponse, never, never>;
type GetOne = {
...
export const getOneQueryKey = (id: MaybeRef<GetOnePathParams["id"]>, params?: MaybeRef<GetOne["queryParams"]>) => [{ url: "/contracts/:id", params: { id: id } }, ...(params ? [params] : [])] as const;
