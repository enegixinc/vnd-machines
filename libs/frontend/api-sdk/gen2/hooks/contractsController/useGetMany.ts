...
import type { GetManyQueryResponse, GetManyQueryParams } from "../../types/GetMany";
...
import type { MaybeRef } from "vue";
 ...
 type GetManyClient = typeof client<GetManyQueryResponse, never, never>;
type GetMany = {
...
export const getManyQueryKey = (params?: MaybeRef<GetMany["queryParams"]>) => [{ url: "/contracts" }, ...(params ? [params] : [])] as const;
