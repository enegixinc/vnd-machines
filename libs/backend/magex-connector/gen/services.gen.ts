...
import type {
  DeleteApiPromosByIdData,
  DeleteApiPromosByIdResponse,
  DeleteBrandsDeleteByIdData,
  DeleteBrandsDeleteByIdResponse,
  DeleteCategoriesDeleteByIdData,
  DeleteCategoriesDeleteByIdResponse,
  DeleteProductsDeleteByIdData,
  DeleteProductsDeleteByIdResponse,
  GetApiPromosByAccountNameData,
  GetApiPromosByAccountNameResponse,
  GetBrandsByAccountNameData,
  GetBrandsByAccountNameResponse,
  GetCategoriesByAccountNameData,
  GetCategoriesByAccountNameResponse,
  GetGroupsAndMachinesByAccountNameData,
  GetGroupsAndMachinesByAccountNameResponse,
  GetGroupsAndMachinesForReportByAccountEmailData,
  GetGroupsAndMachinesForReportByAccountEmailResponse,
  GetProductByIdData,
  GetProductByIdResponse,
  GetProductsByAccountNameData,
  GetProductsByAccountNameResponse,
  GetPublicMachinesBySerialData,
  GetPublicMachinesBySerialResponse,
  GetStockLogByMachineIdByFromDateByToDateData,
  GetStockLogByMachineIdByFromDateByToDateResponse,
  PatchApiPromosUpdateByIdData,
  PatchApiPromosUpdateByIdResponse,
  PostApiPromosCreateData,
  PostApiPromosCreateResponse,
  PostBrandsCreateData,
  PostBrandsCreateResponse,
  PostBrandsEditByIdData,
  PostBrandsEditByIdResponse,
  PostCategoriesCreateData,
  PostCategoriesCreateResponse,
  PostMachinesEdit657Ab833C7201F469894300DData,
  PostMachinesEdit657Ab833C7201F469894300DResponse,
  PostOrdersData,
  PostOrdersResponse,
  PostProductsCreateData,
  PostProductsCreateResponse,
  PostUsersCreateData,
  PostUsersCreateResponse,
  PostUsersGetAllEmployeesData,
  PostUsersGetAllEmployeesResponse,
  PostUsersLoginData,
  PostUsersLoginResponse,
  PutCategoriesEditByIdData,
  PutCategoriesEditByIdResponse,
  PutProductsEditByIdData,
  PutProductsEditByIdResponse,
} from './types.gen';
...
export class MachinesService {
  ...
  public getGroupsAndMachinesByAccountName(
    data: GetGroupsAndMachinesByAccountNameData
  ): CancelablePromise<GetGroupsAndMachinesByAccountNameResponse> {
    return this.httpRequest.request({
      method: 'GET',
  ...
  public postMachinesEdit657Ab833C7201F469894300D(
    data: PostMachinesEdit657Ab833C7201F469894300DData = {}
  ): CancelablePromise<PostMachinesEdit657Ab833C7201F469894300DResponse> {
    return this.httpRequest.request({
      method: 'POST',
  ...
  public getPublicMachinesBySerial(
    data: GetPublicMachinesBySerialData
  ): CancelablePromise<GetPublicMachinesBySerialResponse> {
    return this.httpRequest.request({
      method: 'GET',
...
export class ProductsService {
  ...
  public getProductsByAccountName(
    data: GetProductsByAccountNameData
  ): CancelablePromise<GetProductsByAccountNameResponse> {
    return this.httpRequest.request({
      method: 'GET',
   ...
   * @throws ApiError
   */
  public putProductsEditById(
    data: PutProductsEditByIdData
  ): CancelablePromise<PutProductsEditByIdResponse> {
    return this.httpRequest.request({
      method: 'PUT',
  ...
  public postProductsCreate(
    data: PostProductsCreateData = {}
  ): CancelablePromise<PostProductsCreateResponse> {
    return this.httpRequest.request({
      method: 'POST',
      url: '/products/create',
      formData: data.formData,
  ...
  public deleteProductsDeleteById(
    data: DeleteProductsDeleteByIdData
  ): CancelablePromise<DeleteProductsDeleteByIdResponse> {
    return this.httpRequest.request({
      method: 'DELETE',
...
export class CategoriesService {
  ...
  public getCategoriesByAccountName(
    data: GetCategoriesByAccountNameData
  ): CancelablePromise<GetCategoriesByAccountNameResponse> {
    return this.httpRequest.request({
      method: 'GET',
  ...
  public putCategoriesEditById(
    data: PutCategoriesEditByIdData
  ): CancelablePromise<PutCategoriesEditByIdResponse> {
    return this.httpRequest.request({
      method: 'PUT',
   ...
   * @throws ApiError
   */
  public deleteCategoriesDeleteById(
    data: DeleteCategoriesDeleteByIdData
  ): CancelablePromise<DeleteCategoriesDeleteByIdResponse> {
    return this.httpRequest.request({
      method: 'DELETE',
  ...
  public postCategoriesCreate(
    data: PostCategoriesCreateData = {}
  ): CancelablePromise<PostCategoriesCreateResponse> {
    return this.httpRequest.request({
      method: 'POST',
...
export class ReportsService {
  ...
  public getGroupsAndMachinesForReportByAccountEmail(
    data: GetGroupsAndMachinesForReportByAccountEmailData
  ): CancelablePromise<GetGroupsAndMachinesForReportByAccountEmailResponse> {
    return this.httpRequest.request({
      method: 'GET',
...
export class OrdersService {
  ...
  public postOrders(
    data: PostOrdersData = {}
  ): CancelablePromise<PostOrdersResponse> {
    return this.httpRequest.request({
      method: 'POST',
      url: '/orders',
...
export class UsersService {
  ...
  public postUsersGetAllEmployees(
    data: PostUsersGetAllEmployeesData = {}
  ): CancelablePromise<PostUsersGetAllEmployeesResponse> {
    return this.httpRequest.request({
      method: 'POST',
  ...
  public postUsersCreate(
    data: PostUsersCreateData = {}
  ): CancelablePromise<PostUsersCreateResponse> {
    return this.httpRequest.request({
      method: 'POST',
      url: '/users/create',
      headers: {
...
export class StockingService {
  ...
  public getStockLogByMachineIdByFromDateByToDate(
    data: GetStockLogByMachineIdByFromDateByToDateData
  ): CancelablePromise<GetStockLogByMachineIdByFromDateByToDateResponse> {
    return this.httpRequest.request({
      method: 'GET',
...
export class BrandsService {
  ...
  public getBrandsByAccountName(
    data: GetBrandsByAccountNameData
  ): CancelablePromise<GetBrandsByAccountNameResponse> {
    return this.httpRequest.request({
      method: 'GET',
  ...
  public postBrandsEditById(
    data: PostBrandsEditByIdData
  ): CancelablePromise<PostBrandsEditByIdResponse> {
    return this.httpRequest.request({
      method: 'POST',
      url: '/brands/edit/{_id}',
      path: {
   ...
   * @throws ApiError
   */
  public deleteBrandsDeleteById(
    data: DeleteBrandsDeleteByIdData
  ): CancelablePromise<DeleteBrandsDeleteByIdResponse> {
    return this.httpRequest.request({
      method: 'DELETE',
  ...
  public postBrandsCreate(
    data: PostBrandsCreateData = {}
  ): CancelablePromise<PostBrandsCreateResponse> {
    return this.httpRequest.request({
      method: 'POST',
      url: '/brands/create',
      headers: {
...
export class PromotionsService {
   ...
   * @throws ApiError
   */
  public getApiPromosByAccountName(
    data: GetApiPromosByAccountNameData
   ...
   * @throws ApiError
   */
  public postApiPromosCreate(
    data: PostApiPromosCreateData = {}
   ...
   * @throws ApiError
   */
  public deleteApiPromosById(
    data: DeleteApiPromosByIdData
   ...
   * @throws ApiError
   */
  public patchApiPromosUpdateById(
    data: PatchApiPromosUpdateByIdData
